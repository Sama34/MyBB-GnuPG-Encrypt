...
$l['setting_gnupg_encrypt_wrap_2fa'] = 'Wrap 2FA PGP Message';
$l['setting_gnupg_encrypt_wrap_2fa_desc'] = 'Turn this on to wrap the 2FA PGP message with a <code>[code]PGP MESSAGE[/code].</code>';
